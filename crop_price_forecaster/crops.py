def crop(crop_name):
    crop_data = {
    "wheat":["/static/images/wheat.jpg", "Uttar pradesh, Punjab, Haryana, Rajasthan, Madhya Pradesh, bihar", "rabi","Sri Lanka, United Arab Emirates, Taiwan"],
    "paddy":["/static/pdy.jpg", "West Bengal, Uttar Pradesh, Andhra Pradesh, Punjab, Tamilnadu", "kharif","Bangladesh, Saudi Arabia, Iran"],
    ...
    "niger":["/static/nvu.webp", "Andha Pradesh, Assam, Chattisgarh, Gujarat, Jharkhand", "kharif", "United States of American,Argenyina, Belgium"],
